...
export const SITE_SEARCH_INDEX: SiteSearchItem[] = [
  ...
  { title: "ID Verification", href: "/verify", category: "Page", keywords: ["verify", "portal", "employee id"] },
  {
    title: "Internship Terms and Conditions Unpaid",
    href: "/internship-terms",
    category: "Page",
    keywords: ["unpaid internship", "terms", "internship terms and conditions"],
  },
